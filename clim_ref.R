#-------------------------------------------------------------------------------
# Script to compute probabilistic and binary climatologies based on ten
# years preceding forecast year
#
...
for (m in months) {
  for (t in fYears) {
    ...
    #save(clim_prob, file = sprintf("Results/clim_prob/clim_prob_month%i_year%i.rda",
    #                               m, t))
    ...
    #save(clim_bin, file = sprintf("Results/clim_bin/clim_bin_month%i_year%i.rda",
    #                              m, t))
    print(c(m, t))
  }
}
