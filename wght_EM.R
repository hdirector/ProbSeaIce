#-------------------------------------------------------------------------------
# Script that creates the two-component mixture of the contour model and 
# climatology that makes up MCF (also produces Figure 7 in supplement, showing
# the weight on the two forecast types)
#
# Code to compute the weights on the two models is currently commented out. 
# Figure can be generated with just the summary data table: weights.rda
# 
# To run sections of code that are currently commented out, the following data 
# and results are required
# Requires Data: ecmwfsipn_sip (array named 'sip' with proportion of members
#                               predicting sea ice from the ECWMF ensemble
#                               on Polar Stereographic grid. Dimensions are year
